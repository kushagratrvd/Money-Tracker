    ...
    return (
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="flex gap-2 justify-end">
                <button type="submit" className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded shadow transition-colors duration-200">
                    {editTx ? "Update" : "Add"} Transaction
                </button>
                {editTx && (
                    <button type="button" onClick={clearEdit} className="bg-gray-400 hover:bg-gray-500 text-white px-4 py-2 rounded shadow transition-colors duration-200">
                        Cancel
                    </button>
                )}
            </div>
