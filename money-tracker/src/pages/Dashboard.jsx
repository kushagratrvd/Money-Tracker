    ...
    <div className="relative min-h-screen bg-gray-50 p-2 sm:p-4">
      <Dialog open={showHelp} onClose={handleCloseHelp} className="fixed z-20 inset-0 overflow-y-auto">
        <div className="flex items-center justify-center min-h-screen backdrop-blur-sm bg-white/30">
          <Dialog.Panel className="bg-white p-4 sm:p-8 rounded-xl shadow-xl w-full max-w-xs sm:max-w-md text-center mx-2">
            ...
            <button onClick={handleCloseHelp} className="mt-4 bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded shadow font-semibold transition-colors duration-200 w-full sm:w-auto">Got it!</button>
          </Dialog.Panel>
        </div>
      </Dialog>
      ...
      <Dialog open={isOpen} onClose={() => setIsOpen(false)} className="fixed z-10 inset-0 overflow-y-auto">
        <div className="flex items-center justify-center min-h-screen backdrop-blur-sm bg-white/30">
          <Dialog.Panel className="bg-white p-4 sm:p-6 rounded-lg shadow-xl w-full max-w-xs sm:max-w-md mx-2">
            ...
            />
            <button onClick={() => setIsOpen(false)} className="mt-4 text-gray-500 hover:text-gray-700 w-full sm:w-auto">Close</button>
          </Dialog.Panel>
        </div>
      </Dialog>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4 sm:gap-0">
        ...
        <button onClick={handleLogout} className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded shadow transition-colors duration-200 w-full sm:w-auto">
          Logout
        </button>
      </div>
